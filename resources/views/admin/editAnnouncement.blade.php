    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col px-4 my-4">
                <a href="{{ route('admin.listAnnouncements') }}" class="btn btn-secondary mb-3"><i class="bi bi-arrow-left"></i></a>
                <h1>Edit Announcement</h1>
                <form action="{{ route('admin.updateAnnouncement', $announcement->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        @if($announcement->image)
                            <img src="{{ $announcement->image }}" alt="Image" class="img-thumbnail mt-2" style="max-width: 200px;">
                        @endif
                    </div>
                    <div class="mb-3">
