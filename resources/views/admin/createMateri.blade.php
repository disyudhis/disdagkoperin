                ...
                <div class="w-100" style="max-width: 600px;">
                    ...
                    <form id="materiForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="materialDescription" class="form-control custom-textarea"
                        ...
                        <div id="subMaterialContainer" class="mb-3">
                            <label class="form-label">Sub-Material</label>
                            <div class="input-group mb-2">
                                <input type="text" class="form-control" name="subMaterial[]"
                                    placeholder="Enter sub-material">
                                <button class="btn btn-outline-secondary add-sub-material" type="button"><i
    ...
    <script src="wub/js/editor.js"></script>
        ...
        $(document).ready(function() {
            $('#materiForm').on('click', '.add-sub-material', function() {
                ...
                <div class="input-group mb-2">
                    <input type="text" class="form-control" name="subMaterial[]" placeholder="Enter sub-material">
