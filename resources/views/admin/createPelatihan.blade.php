...
<body>
 <div class="container-fluid">
    <div class="row flex-nowrap">
        <div class="col-auto col-lg-3 col-xl-2 px-sm-2 px-0 bg-blue text-white">
          <div class="d-flex flex-column align-items-center align-items-sm-center min-vh-100 px-3 pt-3">
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0  me-5 align-items-center align-items-sm-start" id="menu">
        ...
        <div class="col py-2 px-4 mt-5">
            <div class="w-100" style="max-width: 600px;">
                <h2 class="mb-4">Input Pelatihan</h2>
                <form id="pelatihanForm">
                    <div class="mb-3">
                        <label for="materialName" class="form-label">Nama Pelatihan</label>
                        <input type="text" class="form-control" id="materialName" placeholder="Enter nama pelatihan">
                    </div>
                    <div class="mb-3">
                            <label for="materialDescription" class="form-label">Description</label>
                            <textarea id="materialDescription" class="form-control custom-textarea" placeholder="Enter description"></textarea>
                    </div>
                    <div class="file-upload mb-3">
                            <label for="mediaUpload" class="form-label">Upload Image/Video</label>
                            <input type="file" id="mediaUpload" class="form-control" accept="image/*,video/*">
                    </div>
                    <div class="mb-3">
                        <label for="pelatihanType" class="form-label">Type of Pelatihan</label>
                        <select id="pelatihanType" class="form-select">
                            <option value="" disabled selected>Select Pelatihan</option>
  ...
  <script src="wub/js/editor.js"></script>
</body>
</html>