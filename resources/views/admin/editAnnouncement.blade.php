                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.updateAnnouncement', $announcement->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="6" required>{{ $announcement->description }}</textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="image-upload-container">
                                            @if ($announcement->image)
                                                <div class="existing-image-preview mb-3">
                                                    ...
                                                    <img src="{{ App\Http\Controllers\AuthController::getUrlForImage($announcement->image) }}"
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <a href="{{ route('admin.listAnnouncements') }}" class="btn btn-secondary">
