            ...
            <div class="col py-2 px-4 mt-5">
                ...
                <form action="{{ route('admin.storeNews') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="newsDescription" name="description" rows="4"
                            placeholder="Enter news description"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="newsDate" class="form-label">Date</label>
                        <input type="date" class="form-control" id="newsDate" name="date">
                    </div>
